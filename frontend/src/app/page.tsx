            ...
            <section className="relative overflow-hidden bg-gradient-to-b from-blue-50 to-white pt-16 dark:from-gray-900 dark:to-gray-800">
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        >
                            Connect with clients looking for your skills. Browse
                            projects or post your own in just a few clicks.
                        </motion.p>
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="mx-auto mt-3 max-w-2xl text-xl text-gray-600 dark:text-gray-300">
                            A modern platform for freelancers and clients to
                    ...
                    <div className="flex flex-col items-center justify-between gap-8 text-center lg:flex-row lg:text-left">
                        <div>
                            ...
                            <p className="mt-3 max-w-lg text-lg text-blue-100">
                                ...
                                today. Find your next project or post one in
                                minutes.
                            </p>
                        </div>
...
const features = [
    {
        ...
        description:
            "Browse through a wide variety of technical projects looking for your specific skills and expertise.",
    },
    {
        icon: DollarSign,
        title: "Transparent Pricing",
        description:
            "Clear budget information upfront. No hidden fees or surprises when working on projects.",
    },
    {
        icon: Briefcase,
        title: "Post Your Projects",
        description:
            "Easily post your own projects and connect with skilled freelancers ready to help.",
    },
    {
        icon: CheckCircle,
        title: "Seamless Experience",
        description:
            "Modern interface with a smooth user experience, making project management a breeze.",
    },
];
