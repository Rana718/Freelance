...
import {
  Loader2, LogOut, User, Edit, Upload,
  ThumbsUp, MessageCircle, Image as ImageIcon
} from "lucide-react";
...
export default function ProfilePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      <div className="mb-6 grid gap-4 sm:gap-6 md:grid-cols-3">
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-lg font-bold sm:text-xl">{session?.user?.name}</h2>
            <p className="mb-4 text-sm text-gray-600 dark:text-gray-300 sm:text-base">{session?.user?.email}</p>
        ...
        >
          <div className="mb-3 flex items-center justify-between">
            <h2 className="text-base font-semibold sm:text-lg">Your Activity</h2>
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex-1 rounded bg-gray-50 px-2 py-2 text-center dark:bg-gray-700">
              <h3 className="text-lg font-semibold text-blue-600">{projects.length}</h3>
              <p className="text-xs text-gray-600 dark:text-gray-300">Projects</p>
            </div>
            <div className="flex-1 rounded bg-gray-50 px-2 py-2 text-center dark:bg-gray-700">
              <h3 className="text-lg font-semibold text-blue-600">0</h3>
              <p className="text-xs text-gray-600 dark:text-gray-300">Likes</p>
            </div>
            <div className="flex-1 rounded bg-gray-50 px-2 py-2 text-center dark:bg-gray-700">
              <h3 className="text-lg font-semibold text-blue-600">0</h3>
              <p className="text-xs text-gray-600 dark:text-gray-300">Comments</p>
            </div>
          </div>
        </motion.div>
      ...
      {/* Projects Section */}
      <div className="mb-6">
        <h2 className="mb-4 text-lg font-bold sm:text-xl">Your Projects</h2>
  ...
  return (
    ...
    >
      ...
      <div className="p-3 sm:p-4">
        <h3 className="mb-1.5 text-base font-semibold sm:mb-2 sm:text-lg">{project.title}</h3>
